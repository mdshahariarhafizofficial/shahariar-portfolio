...
const Navbar = () => {
     const navLinks = ['home', 'about', 'skills', 'education', 'portfolio', 'contact'];
      const [active, setActive] = useState('home'); // by default 'home'

    // ScrollSpy auto update kore
    const handleSetActive = (to) => {
        setActive(to);
    };
return (
<div className="max-w-[1320px] mx-auto navbar shadow-sm bg-[#000000d2] py-5">
  <div className="navbar-start">
    <div className="dropdown">
      <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="#20938a"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /> </svg>
      </div>
      <ul
        tabIndex={0}
      ...
      {navLinks.map((section) => (
        ...
        >
          ...
          {/* Gradient Underline — from #9ca3af to #20938a (left to right) */}
          <span
